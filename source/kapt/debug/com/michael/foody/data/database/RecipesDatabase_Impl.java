  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `recipes_table` (`foodRecipe` TEXT NOT NULL, `id` INTEGER NOT NULL, PRIMARY KEY(`id`))");
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        if (! _infoRecipesTable.equals(_existingRecipesTable)) {
          return new RoomOpenHelper.ValidationResult(false, "recipes_table(com.michael.foody.data.database.entities.RecipesEntity).\n"
                  + " Expected:\n" + _infoRecipesTable + "\n"
        ...
        if (! _infoFavoriteRecipesTable.equals(_existingFavoriteRecipesTable)) {
          return new RoomOpenHelper.ValidationResult(false, "favorite_recipes_table(com.michael.foody.data.database.entities.FavoritesEntity).\n"
        ...
        if (! _infoFoodJokeTable.equals(_existingFoodJokeTable)) {
          return new RoomOpenHelper.ValidationResult(false, "food_joke_table(com.michael.foody.data.database.entities.FoodJokeEntity).\n"
                  + " Expected:\n" + _infoFoodJokeTable + "\n"
                  + " Found:\n" + _existingFoodJokeTable);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "8b0559db028e55141e5e89d382d86a36", "ebf6659d2fb19b488af779f8cb19af46");
