...
public final class RecipesDao_Impl implements RecipesDao {
  ...
  private final SharedSQLiteStatement __preparedStmtOfDeleteAllFavoritesRecipes;
  ...
  public RecipesDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfRecipesEntity = new EntityInsertionAdapter<RecipesEntity>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR REPLACE INTO `recipes_table` (`foodRecipe`,`id`) VALUES (?,?)";
      }

      @Override
      public void bind(SupportSQLiteStatement stmt, RecipesEntity value) {
        final String _tmp = __recipesTypeConverter.foodRecipeToString(value.getFoodRecipe());
        if (_tmp == null) {
          stmt.bindNull(1);
        } else {
    ...
    this.__insertionAdapterOfFavoritesEntity = new EntityInsertionAdapter<FavoritesEntity>(__db) {
      ...
      public void bind(SupportSQLiteStatement stmt, FavoritesEntity value) {
        ...
        final String _tmp = __recipesTypeConverter.resultToString(value.getResult());
        if (_tmp == null) {
          stmt.bindNull(2);
        } else {
    ...
    this.__preparedStmtOfDeleteAllFavoritesRecipes = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
  ...
  @Override
  public Object deleteAllFavoritesRecipes(final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      public Unit call() throws Exception {
        final SupportSQLiteStatement _stmt = __preparedStmtOfDeleteAllFavoritesRecipes.acquire();
        __db.beginTransaction();
        try {
          ...
          __db.endTransaction();
          __preparedStmtOfDeleteAllFavoritesRecipes.release(_stmt);
        }
      }
    }, $completion);
  }
      ...
      public List<RecipesEntity> call() throws Exception {
        ...
        try {
          ...
          while(_cursor.moveToNext()) {
            ...
            final String _tmp;
            if (_cursor.isNull(_cursorIndexOfFoodRecipe)) {
              _tmp = null;
            } else {
