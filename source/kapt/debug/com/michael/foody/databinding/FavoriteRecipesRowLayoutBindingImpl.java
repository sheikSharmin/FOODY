...
public class FavoriteRecipesRowLayoutBindingImpl extends FavoriteRecipesRowLayoutBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.favoritesEntity == variableId) {
            setFavoritesEntity((com.michael.foody.data.database.entities.FavoritesEntity) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setFavoritesEntity(@Nullable com.michael.foody.data.database.entities.FavoritesEntity FavoritesEntity) {
    ...
    protected void executeBindings() {
        ...
        java.lang.String stringValueOfFavoritesEntityResultReadyInMinutes = null;
        ...
        java.lang.String stringValueOfFavoritesEntityResultAggregateLikes = null;
        com.michael.foody.models.Result favoritesEntityResult = null;
        ...
        com.michael.foody.data.database.entities.FavoritesEntity favoritesEntity = mFavoritesEntity;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
                ...
                // read String.valueOf(favoritesEntity.result.readyInMinutes)
                stringValueOfFavoritesEntityResultReadyInMinutes = java.lang.String.valueOf(favoritesEntityResultReadyInMinutes);
                // read String.valueOf(favoritesEntity.result.aggregateLikes)
                stringValueOfFavoritesEntityResultAggregateLikes = java.lang.String.valueOf(favoritesEntityResultAggregateLikes);
        }
        // batch finished
        if ((dirtyFlags & 0x3L) != 0) {
            // api target 1

            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.favoriteClockTextView, stringValueOfFavoritesEntityResultReadyInMinutes);
            com.michael.foody.bindingadapters.RecipesRowBinding.parseHtml(this.favoriteDescriptionTextView, favoritesEntityResultSummary);
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.favoriteHeartTextView, stringValueOfFavoritesEntityResultAggregateLikes);
            com.michael.foody.bindingadapters.RecipesRowBinding.applyVeganColor(this.favoriteLeafImageView, favoritesEntityResultVegan);
            com.michael.foody.bindingadapters.RecipesRowBinding.applyVeganColor(this.favoriteLeafTextView, favoritesEntityResultVegan);
            com.michael.foody.bindingadapters.RecipesRowBinding.loadImageFromUrl(this.favoriteRecipeImageView, favoritesEntityResultImage);
