...
public class RecipesRowLayoutBindingImpl extends RecipesRowLayoutBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.result == variableId) {
            setResult((com.michael.foody.models.Result) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setResult(@Nullable com.michael.foody.models.Result Result) {
        this.mResult = Result;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        java.lang.String stringValueOfResultAggregateLikes = null;
        com.michael.foody.models.Result result = mResult;
        boolean resultVegan = false;
        int resultAggregateLikes = 0;
        java.lang.String resultSummary = null;
        java.lang.String stringValueOfResultReadyInMinutes = null;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
                ...
                // read String.valueOf(result.readyInMinutes)
                stringValueOfResultReadyInMinutes = java.lang.String.valueOf(resultReadyInMinutes);
                // read String.valueOf(result.aggregateLikes)
                stringValueOfResultAggregateLikes = java.lang.String.valueOf(resultAggregateLikes);
        }
        // batch finished
        if ((dirtyFlags & 0x3L) != 0) {
            // api target 1

            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.clockTextView, stringValueOfResultReadyInMinutes);
            com.michael.foody.bindingadapters.RecipesRowBinding.parseHtml(this.descriptionTextView, resultSummary);
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.heartTextView, stringValueOfResultAggregateLikes);
            com.michael.foody.bindingadapters.RecipesRowBinding.applyVeganColor(this.leafImageView, resultVegan);
            com.michael.foody.bindingadapters.RecipesRowBinding.applyVeganColor(this.leafTextView, resultVegan);
            com.michael.foody.bindingadapters.RecipesRowBinding.loadImageFromUrl(this.recipeImageView, resultImage);
            com.michael.foody.bindingadapters.RecipesRowBinding.onRecipeClickListener(this.recipesRowLayout, result);
