package com.michael.foody.ui.fragments.foodjoke;
...
public abstract class Hilt_FoodJokeFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FoodJokeFragment() {
    super();
  }

  Hilt_FoodJokeFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FoodJokeFragment_GeneratedInjector) this.generatedComponent()).injectFoodJokeFragment(UnsafeCasts.<FoodJokeFragment>unsafeCast(this));
    }
  }
