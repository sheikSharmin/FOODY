...
public abstract class Hilt_FavoriteRecipesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FavoriteRecipesFragment() {
    super();
  }

  Hilt_FavoriteRecipesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FavoriteRecipesFragment_GeneratedInjector) this.generatedComponent()).injectFavoriteRecipesFragment(UnsafeCasts.<FavoriteRecipesFragment>unsafeCast(this));
    }
  }
