...
public abstract class Hilt_RecipesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RecipesFragment() {
    super();
  }

  Hilt_RecipesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RecipesFragment_GeneratedInjector) this.generatedComponent()).injectRecipesFragment(UnsafeCasts.<RecipesFragment>unsafeCast(this));
    }
  }
